...
class Core:
    ...
    def __init__(self, file_handler):
        ...
        for x in range(len(self.contact_list)):
            self.contact_list[x] = Contact(
                self.contact_list[x]["name"],
                self.contact_list[x]["number"],
                self.contact_list[x]["address"],
            )
    ...
    def get_contact_details(self, id):
        ...
        details = [
            intended_contact.name,
            intended_contact.number,
            intended_contact.address,
        ]
        return details
    ...
    def write_current_contact_list_to_file(self):
        ...
        for x in range(len(self.contact_list)):
            contact_in_dict = {
                "name": self.contact_list[x].name,
                "number": self.contact_list[x].number,
                "address": self.contact_list[x].address,
                "id": self.contact_list[x].id,
            }
